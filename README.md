...
A font request has the signature `"family size face"` ex: `"Verdana 16 bold italic"`. Requests are explicit so, any part of a font can be changed. tto be clearer, any part that you do not explicitly change, will not change.
